...
class ViewBalanceFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val currentBalance = arguments?.getDouble("userbalance", 100.0) ?: 100.0

        val amount = view.findViewById<TextView>(R.id.viewBalanceAmountTextView)
        val formattedBalance = String.format("%.2f", currentBalance)
        amount.text = "$$formattedBalance"
